...
- `docs/commercial/deployment-options.md` — deployment options and data contour wording.
- `docs/legal/claims-and-limitations.md` — safe claims and forbidden wording.
