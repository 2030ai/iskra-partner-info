...
- follow redirects manually, preserve the configured timeout across the redirect chain, and validate each effective URL before downloading, parsing or reporting the response body;
